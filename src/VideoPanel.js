...
class VideoPanel extends Component {
  ...
  handleStateChange = e => {
    ...
    let vidChange = e.target.currentVidEvent
    this.setState({
       [vidChange]: value
...
//slider stuff
  formatTips = seconds => {
    console.log("seconds to mins wtf", this.secondsToMinutes(seconds));
